...
exports.download = async (req, res, next) => {
	...
	try {
		...
		const transformer = (doc) => {
			return {
				"Order Id": doc._id,
				"Invoice Id": doc.invoice,
				"Receipent Name": doc.customer.name,
				"Receipent Number": doc.customer.phone,
				"Receipent Address": doc.customer.address,
				"Order Type": doc.type,
				Total: doc.total - doc.discount,
				Paid: doc.paid,
				Due: doc.due,
			};
		};
